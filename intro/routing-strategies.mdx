...
At present, we offer two routing strategies: **Economy** and **Performance**. Sometimes referred to as low cost or low latency.
...
Economy keys are optimised to use the cheapest provider and keep falling back until a request works. **Note:** the maximum wait time until the next provider is dependent on the key type you use.
